...
window.BUILD_PLANS = [
  ...
  // ===== YIELD (180m²) =====
  {
    ...
    tag: "投資用アパート・1K×6戸",
    tagColor: "#6080c0",
    desc: "【Phase 2 / 大臣認定取得後リリース予定】180m²を25m²×6戸の1Kアパートに分割した賃貸住宅プラン（賃貸住宅管理業法対応・民泊/旅館業ではない）。1F 3戸+2F 3戸+共用廊下+メーター室+ゴミ置き場+駐輪場。各戸独立給湯・独立メーター・LH-45サウンドプルーフ間仕切りで隣戸音漏れゼロ。地方都市〜中核市の駅徒歩10分圏を想定。想定家賃¥87,500/月/戸×6戸=月¥52.5万=年¥630万、表面利回り6.6%（建築費基準・土地代別・空室率0%）。法定耐用年数22年（木造）で融資は耐用年数内が一般的。耐震等級3+準耐火構造で30年保有を見据えた長期投資物件。",
    totalMat: 95000000,
    subsidyMax: 2400000,
    ...
    specs: [
      ...
      {k:"想定家賃", v:"¥87,500/月/戸（地方中核市駅徒歩10分の1K相場 SUUMO参照値・敷地により変動）"},
      {k:"想定表面利回り", v:"6.6%（家賃¥87,500×6戸×12÷建築費¥9,500万・土地代別・空室率0%）"},
      {k:"運営許可", v:"共同住宅（賃貸住宅管理業法 + 宅建業法 + 消防法施行令第12条 自火報・誘導灯）"},
      {k:"界壁", v:"小屋裏まで遮音遮炎・準耐火30分以上（建築基準法施行令114条）"},
      {k:"界床", v:"床衝撃音 LH-45 / LL-45（推奨）— 二重床+遮音マット+グラスウール80kg"},
      {k:"避難経路", v:"二方向避難確保・直通階段+共用廊下幅1.2m以上・歩行距離50m以下"},
      {k:"採光・換気", v:"各戸採光 床面積1/7以上 / 換気 床面積1/20以上（建築基準法第28条）"},
      {k:"法定耐用年数", v:"22年（木造）— 融資年数は耐用年数内が一般的・金融機関により最長25-30年"},
      {k:"耐震等級", v:"等級3 想定（性能評価未取得・大臣認定取得後Phase 2リリース）"},
      {k:"設計監理", v:"提携1級建築士事務所と個別連携（事務所登録番号は契約時に開示）"},
      {k:"建築確認", v:"必須（建築士設計・構造計算・耐震等級3・準耐火認定）"},
    ],
    materials: [
