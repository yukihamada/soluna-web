...
window.BUILD_PLANS = [
  ...
  // ===== YIELD (180m²) =====
  {
    ...
    tag: "投資用アパート・1K×6戸",
    tagColor: "#6080c0",
    desc: "180m²を25m²×6戸の1Kアパートに分割した不動産投資特化プラン。1F 3戸+2F 3戸+共用廊下+メーター室+ゴミ置き場+駐輪場。各戸独立給湯・独立メーター・LH-50サウンドプルーフ間仕切りで隣戸音漏れゼロ。地方都市〜中核市の駅徒歩10分圏を想定。家賃想定¥87,500/月/戸×6戸=月¥52.5万=年¥630万、表面利回り6.6%/年(対土地+建物)。耐震等級3+準耐火構造で30年保有を見据えた長期投資物件。",
    totalMat: 95000000,
    subsidyMax: 2400000,
    ...
    specs: [
      ...
      {k:"構造", v:"SIPs+ALC30mm耐火被覆 木造2階建て（準耐火構造・サウンドプルーフLH-50）"},
    ...
    materials: [
      {cat:"SIPs+ALC耐火被覆+サウンドプルーフ",emoji:"🏗️",total:18000000,color:"#6080c0",
       items:[
         ...
         {name:"ALC 30mm 耐火被覆パネル",qty:"320 m²",unit:"¥6,500/m²",total:2080000,note:"準防火地域認定"},
         {name:"サウンドプルーフ間仕切壁 LH-50（戸間仕切り）",qty:"110 m²",unit:"¥18,000/m²",total:1980000,note:"遮音等級LH-50"},
      ...
      {cat:"断熱・気密",emoji:"🌡️",total:1800000,color:"#7080e0",
       items:[
         ...
         {name:"戸間遮音吸音材（グラスウール80kg/m³）",qty:"110 m²",unit:"¥3,800/m²",total:418000,note:"LH-50用"},
    ...
    steps: [
      ...
      {week:"W14〜26",phase:"SIPs+ALC耐火被覆+サウンドプルーフ取付",icon:"🔷",cost:18000000,diff:"★★★★☆",people:"6〜8人",
       desc:"320m²の壁パネル+96m²の屋根+ALC耐火被覆+戸境LH-50間仕切り。13週間。", tools:["インパクト","コーキングガン","足場"],tips:"戸境壁の遮音はパネルとパネルの隙間1mmでも音漏れする。テープシール完璧に。"},
    ...
    elevSvg: `<svg viewBox="0 0 560 280" style="width:100%;background:#050505;display:block">
      ...
      <text x="20" y="14" fill="#6080c0" font-size="9" font-weight="bold">YIELD — 南立面（2階建て・1K×6戸・LH-50遮音・耐震等級3）</text>
    </svg>`,
  },
  // ===== ROOTS (60m²) =====
  {
