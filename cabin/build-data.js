...
window.BUILD_PLANS = [
  ...
  // ===== MYTH (300m²) =====
  {
    ...
    rentPerNight: 200000,
    color: "#c89020",
    img: "/img/build/myth_exterior.jpg",
    lifeImgs: [
      {src:"/img/build/myth_hall.jpg",     cap:"食堂ホール 90m²（収容28名・吹抜け3.4m）"},
      {src:"/img/build/myth_lounge.jpg",   cap:"ライブラリ・静寂室（メザニン）"},
      {src:"/img/build/myth_room.jpg",     cap:"ゲスト個室 14室（白木の禅室）"},
      {src:"/img/build/myth_sauna.jpg",    cap:"バレルサウナ + 水風呂 + 外気浴デッキ"},
      {src:"/img/build/myth_aerial.jpg",   cap:"空撮・敷地一体の中央拠点"},
      {src:"/img/build/myth_exterior.jpg", cap:"南面ファサード(夕景・大開口W7m)"},
    ],
    specs: [
