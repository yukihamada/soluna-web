...
window.BUILD_PLANS = [
  ...
  // ===== TAMA (27m² ジオデシックドーム) =====
  {
    ...
    routes: [
      {label:"セルフビルド",cost:2276900,desc:"材料費のみ。工期8週間（延べ20人工）"},
      {label:"補助金後",cost:1876900,desc:"こどもエコすまい支援事業等 最大40万円活用後"},
      {label:"暖地仕様（九州・沖縄）",cost:2026900,desc:"断熱仕様を薄くして削減"},
      {label:"ワークパーティー施工",cost:2126900,desc:"SOLUNAビレッジメンバーとの共同作業"},
    ],
  ...
  // ===== MYTH (300m²) =====
  {
    ...
    materials: [
      {cat:"SIPsパネル（壁・屋根）",emoji:"🏗️",total:11600000,color:"#c89020",url:"",alt:"",
       items:[
         {name:"SIPsパネル 壁用 160mm",qty:"750 m²",unit:"¥12,000/m²",total:9000000,note:"1F+2F全周+間仕切り+14室区画"},
