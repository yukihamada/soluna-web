...
export default function OsPage() {
  const [isFrame, setIsFrame] = useState<boolean | null>(null);
  ...
  if (isFrame === null || isFrame === false) return null;

  return (
    <div style={{ padding: "32px 40px 48px", fontFamily: "Inter, -apple-system, sans-serif" }}>
